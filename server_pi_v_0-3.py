                ...
                try:
                    ...
                    while not cameradata:
                        try:
                            ...
                            print("[PithYaw(Thread)] : no data in stereStack")

                    LeftXcoord = stereodata.masterval
                    RightXcoord = stereodata.slaveval
                    stereoDistance = int(stereodata.distance)
                    ...
                    #
                    lateralDisplacement = (2464 - LeftXcoord - RightXcoord)
                    if futureDist:
                        # Use normal method
                        drillSpeedPitchAdjust = 
                    else:
                        if finalDist:
                            # Calculate prediction using finalDist and lateralDisplacement
                        else:
                            # Calculate prediction using stereoDist and lateralDisplacement
