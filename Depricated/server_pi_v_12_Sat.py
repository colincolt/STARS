...
#                    self.latPixelDisp += (self.dynamic_pixel_buff / usedDistance)
                    ...
                    if scaled_pid == 0:
                        ...
                        scaled_pid = 150
                    elif (-20 < scaled_pid < 20):
                        scaled_pid = 0
                    elif (-20 > scaled_pid > -self.low_limit):
                    ...
                    print("[PithYawThread:Future] SENT: <motorSpeed, pitchAngle> =  " + data)
                    time.sleep(0.1)
...
def StereoscopicsThread(stereoStack, shutdown_event, kill_event):
    ...
    if not shutdown_event.isSet() and not kill_event.isSet():
        ...
        time.sleep(3.0)  # < Let Video Thread startup
