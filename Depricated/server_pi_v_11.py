...
class PitchYaw(Thread):
    ...
    def run(self):
        ...
        launcherAngle = 0
        low_limit = 150 # < LOWER LIMIT FOR YAW MOTOR POWER
            ...
            try:
                if drillType == 'Dynamic':
                    ...
                    if FUT_FINAL_DIST is None or FUT_FINAL_DIST == OLD_FUT_FINAL_DIST:  # <- no prediction is done in this thread so it will send AS IS
                        ...
                        ballFeed = 1
                        data = '<' + MotorSpeed + ',' + MotorSpeed + ',' + str(targetChoice) + ',' + str(difficulty) + ',' + str(ballFeed) + ',' + str(estimated_tof) + '>'
                ...
                if drillType == 'Manual':  # __________#_______________#________________#__________________#_______________#
