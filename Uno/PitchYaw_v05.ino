...
// long encodercount = 0;
 ...
 PID myPID_Yaw(&Input_2, &Output_2, &Setpoint_2,1,0,0,DIRECT);
...
//      Input_2 = (myEnc.read());      
      Input_2 = 5000;
//********ROTATION AMOUNT FROM LEFT OF CENTRE POSITION->EncoderCount=0 ( CLOCKWISE ROTATION )
        if (Input_2 > 0)
        {
           Input_2 = -Input_2;
           myPID_Yaw.Compute();
...
//********ROTATION AMOUNT FROM RIGHT OF CENTRE POSITION->EncoderCount=0 ( COUNTER-CLOCKWISE ROTATION )
        if (Input_2 < 0)
        {
