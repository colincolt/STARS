...
TCP_IP = '192.168.137.200'  # Define the IP address for communication
TCP_PORT = 5005
BUFFER_SIZE = 1024
no_talk = True
connected = True
...
while no_talk == True:
    try:
        serverPi.connect((TCP_IP, TCP_PORT))
        no_talk = False
    except socket.error:
        print('Stereoscopics:   Waiting for Server... ')
        time.sleep(3)
        continue
...
while True:
    ...
    # construct a mask for the color "red jersey", then perform
