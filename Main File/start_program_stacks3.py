...
class Stereoscopics(Thread):
    def __init__(self, sendStereoStack,getethernetPortStack):  # , difficulty, drillType, args, _____):
        Thread.__init__(self)
        #self.difficulty = difficulty
        #self.drillType = drillType
        self.sendStereoStack = sendStereoStack
        self.getethernetPortStack = getethernetPortStack
        #self.args = args
...
##        s = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
        conn = self.getethernetPortStack
...
def startMainFile(speed, difficulty, drilltype):   # , args): ## NOT A THREAD, performs the bulk of calculation       
    ...
    ethernetPortStack.push(clientPort)
...
##            continue
    ...
    stereoscopicsThread = Stereoscopics(stereoStack, ethernetPortStack)
