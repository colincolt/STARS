...
def staticDrill():
    ...
    start_1 = PushButton(window1, command=sendData(drillType, args), text="Begin")
...
def predictiveDrill():
    ...
    start_2 = PushButton(window2, command=sendData(bs, diff, drillType, args), text="Begin")
...
def manualDrill():
    ...
    start_3 = PushButton(window3, command=sendData(drillType, args), text="Begin")
