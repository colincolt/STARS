# /etc/init.d/clientPi.py
### BEGIN INIT INFO
# Provides:         clientPi.py
...
# define the lower and upper boundaries of the "red jersey"
# ball in the HSV color space, then initialize the list of tracked points
jerseyLower1 = (0, 50, 50)
jerseyUpper1 = (5, 255, 255)
jerseyLower2 = (175, 50, 50)
...
# construct a mask for the color "red jersey", then perform a series of dilations
...
# find contours in the mask and initialize the current(x, y) center of the player
