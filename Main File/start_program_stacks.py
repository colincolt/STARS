...
# MAIN FILE START
class startMainFile:   # , args): ## NOT A THREAD, performs the bulk of calculation
    def __init__(self, speed, difficulty, drilltype):  #, sendVoiceCommandStack, sendDistanceStack,):
        Thread.__init__(self)
        self.sendVoiceCommandStack = sendVoiceCommandStack
        self.sendDistanceStack = sendDistanceStack
        self.speed = speed
    ...
    def run(self):
        ...
        # __ GUI Input __ #
        guiData = GuiInput()
        guiData.drillSpeed = speed
        guiData.drillDifficulty = difficulty
        guiData.drillType = drilltype
        print("Speed:  " + str(guiData.drillSpeed) + "Diff:  " + str(guiData.drillDifficulty) + "Drill:  " + print(guiData.drillType))
        StereoStack = Stack()
        distanceStack = Stack()
        guiStack = Stack()
